...
export class HomePageModalComponent implements OnInit {
  ...
  saveItem() {
    if (this.trigger === false) {
      if (
        this.menuItem.foodType !== undefined &&
        this.menuItem.foodType !== "" &&
        this.menuItem.price !== undefined &&
        this.menuItem.price !== "" &&
        this.menuItem.image !== undefined &&
        this.menuItem.image !== "" &&
        this.menuItem.category !== undefined &&
        this.menuItem.category !== ""
      ) {
        this.menuItemsService.saveItem(this.menuItem).then(
          (res) => {
            //emit event
            console.log(res);
      ...
      if (
        ...
        this.menuItemsService.updateItem(this.menuItem.id, this.menuItem).then(
          (res) => {
            //emit event
